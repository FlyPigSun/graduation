...
class Login extends MY_Controller {
    ...
    public function teacherLogin($username,$password){          
        ...
        if(strlen($this->teacher->username)==0){
            ...
            $arr=array("tid"=>$this->teacher->id,"username"=>$this->teacher->username,
              ...
              "class"=>$this->teacher->class,"realname"=>$this->teacher->realname,"role"=>'teacher');
    ...
    public function studentLogin($username,$password,$mood){
        ...
        if(strlen($this->student->username)==0){
            ...
            "class"=>$this->student->class,"role"=>'student',"realname"=>$this->student->realname,"notfirst"=>$this->student->notfirst);
            $this->session->set_userdata($arr);
            $result=100;
        }
        $data['errcode']=$result;
